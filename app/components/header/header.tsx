...
const header = () => {
  return (
    <header className="p-1 md:p-4 max-w-7xl mx-auto px-10 border-gray-700 border bg-[#38416138] shadow-lg rounded-lg">
      <div className="flex flex-col items-center md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
        ...
        <div className=" flex flex-row items-center w-full justify-evenly md:w-fit">
          <Link
            href={"/gallery"}
            className="cursor-pointer text-white hover:text-yellow-300 transition duration-300 mb-2 md:mb-0 md:ml-6"
          >
            Home
          </Link>
          <Link
