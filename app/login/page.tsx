...
const HankoAuth = dynamic(() => import('@/app/components/hanko/HankoAuth'), { ssr: false })
    ...
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="hidden bg-gradient-to-tr from-gray-900 to-black md:w-1/2 p-16 md:flex flex-col justify-center items-center">
        ...
        <p className="text-lg text-gray-300">
          Get started with your Hanko Cloud API access in a few minutes. No
          credit card needed.
        </p>
      </div>
